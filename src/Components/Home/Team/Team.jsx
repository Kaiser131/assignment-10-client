                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                        ...
                        <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                            ...
                            <div className="flex mt-4 -mx-2">
                                <Link className="mx-2 text-xl text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"><FaReddit></FaReddit> </Link>
                                <Link className="mx-2 text-xl text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"><FaFacebook></FaFacebook> </Link>
                                <Link className="mx-2 text-xl text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"><FaGithub></FaGithub> </Link>
                            </div>
